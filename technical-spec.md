...
| Effects | `Sources/Effects` | The effect registry and the descriptors for all 209 built-in effects, organized by category (includes the MAOE interaction, window-chrome, and system-UI effects). |
